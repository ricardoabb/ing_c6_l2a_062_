...
export function Menu({ title = "Phrasal Verbs relating to Health", meaning = "", content = "" }: titleProp) {
    ...
    return (
        ...
        <div className={`absolute ${ activeId <= 0 || activeId === isLast ? 'bottom-[-250px]' : 'bottom-[70px]'}  rounded-none  lg:rounded-t-[80px] w-full lg:w-[750px] pt-4 pb-4  mx-auto bg-opacity-60 z-50 transition-all ease-in-out duration-[.3s]`}>
